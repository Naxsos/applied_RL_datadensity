...
*Pendulum.* On the paper's task with its one-sided excluded band, one Lagrangian setting,
...
*LunarLander.* This environment changes the reward scale (per-step shaping rewards of order
...
*Limitations and outlook.* The evidence is limited to six seeds per setting for Pendulum,
